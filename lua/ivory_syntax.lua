...
local spec = lush(function()
	return {
		...
		markdownH6({ gui = "bold,underline", fg = "#352e2e" }),
		markdownH5({ gui = "bold,underline", fg = "#352e2e" }),
		markdownH4({ gui = "bold,underline", fg = "#352e2e" }),
		markdownH3({ gui = "bold,underline", fg = "#352e2e" }),
		markdownH2({ gui = "bold,underline", fg = "#352e2e" }),
		markdownH1({ gui = "bold,underline", fg = "#352e2e" }),
