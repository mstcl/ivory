...
local spec = lush(function(injected_functions)
	...
	return {
		...
		sym("@markup.heading.6")({ gui = "bold,underline", fg = "#352e2e" }),
		sym("@markup.heading.5")({ gui = "bold,underline", fg = "#352e2e" }),
		sym("@markup.heading.4")({ gui = "bold,underline", fg = "#352e2e" }),
		sym("@markup.heading.3")({ gui = "bold,underline", fg = "#352e2e" }),
		sym("@markup.heading.2")({ gui = "bold,underline", fg = "#352e2e" }),
		sym("@markup.heading.1")({ gui = "bold,underline", fg = "#352e2e" }),
