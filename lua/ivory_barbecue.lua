...
local spec = lush(function()
	return {
		...
		barbecue_context_module({ bg = "#ded8d3", fg = "#cec6bf" }),
		...
		barbecue_context_file({ bg = "#ded8d3", fg = "#cec6bf" }),
		...
		barbecue_context_constant({ bg = "#ded8d3", fg = "#cec6bf" }),
		barbecue_context_key({ barbecue_context_constant }),
		barbecue_context_method({ bg = "#ded8d3", fg = "#cec6bf" }),
		...
		barbecue_context_struct({ bg = "#ded8d3", fg = "#cec6bf" }),
