...
local spec = lush(function()
	return {
		...
		TelescopePreviewBorder({ bg = "#edeae4", fg = "#edeae4" }),
		...
		TelescopeBorder({ bg = "#e5e1d9", fg = "#e5e1d9" }),
		TelescopeNormal({ bg = "#e5e1d9", fg = "#574b42" }),
		TelescopeMultiSelection({ gui = "bold", fg = "#352e2e" }),
		TelescopeSelectionCaret({ bg = "#d7d3cb", fg = "#352e2e" }),
		TelescopeSelection({ bg = "#d7d3cb", gui = "bold", fg = "#352e2e" }),
