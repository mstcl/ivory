...
local spec = lush(function()
	return {
		...
		CmpItemKindFunction({ bg = "#735057", fg = "#c8beb7" }),
		...
		CmpItemKindInterface({ bg = "#543227", fg = "#c8beb7" }),
